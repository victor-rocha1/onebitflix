...
function filterLastEpisodesByCourse(episodes: EpisodeInstance[]) {   //Últimos episódios por curso
    const coursesOnList: number[] = []    //Lista de quais cursos já foram filtrados
    ...
    const lastEpisodes = episodes.reduce((currentList, episode) => {
        ...
        //Lista sem o episódio do mesmo cursos
...
export const userService = {
    ...
    getKeepWatchingList: async (id: number) => {    //Guarda onde o usuário parou
